# omnichannel-product-growth-analysis
End-to-end product analytics project combining segmentation, churn modeling, attribution, and forecasting to identify drivers of customer value and retention, and deliver data-driven recommendations for growth, marketing optimization, and user experience improvement.
